...
module MULQ #(
    ...
    // Queue Storage
    mulq_entry_t                       q       [MUL_QUEUE_DEPTH];
    logic        [MUL_QUEUE_DEPTH-1:0] q_valid;
    ...
    logic [MUL_QUEUE_DEPTH-1:0] flush_mask;
    ...
    always_ff @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            if (dis_mul_en && has_free && !cdb_flush) begin
