module SB #(
    ...
    parameter int unsigned SB_DATA_WIDTH = DMEM_WIDTH + DMEM_DEPTH
) (
    input logic clk,
    input logic rst_n,
    ...
    logic [SB_DATA_WIDTH-1:0] sb_array [SB_DEPTH];
    ...
    always_ff @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            if (rob_commit_mem_write && !full) begin
                sb_array[write_ptr[SB_INDEX_WIDTH-1:0]] <= {rob_sw_addr, rob_sw_data};
